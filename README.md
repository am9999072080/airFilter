# Тестовое задание №2 - Авиаперелеты
![pngwing com](https://github.com/am9999072080/airFilter/assets/127240321/15aec888-9975-4884-b9ff-5c406d3b5f47)
## Задача
...
* Класс Flight - класс перелетов, где реализован интерфейс FlightFilter
* Класс Segment - класс расписания перелетов
* Класс FlightBuilder - фабрика создания перелетов
* Интерфейс FlightFilter - интерфейс для создания фильтров расписании

### Структура классов Test
* Класс FlightTest - для тестирования класса перелетов Flight
